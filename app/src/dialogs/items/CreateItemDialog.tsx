...
import { Item, VariantGroup } from '../../types';
...
interface CreateItemDialogProps {
    open: boolean,
    onClose?: () => void,
    onCreateItem?: (item: Item, callback: () => void) => void
}

export default function CreateItemDialog(props: CreateItemDialogProps) {
    const { open, onClose, onCreateItem } = props;
        ...
        <Dialog open={open} onClose={handleClose} maxWidth="md" fullWidth>
            ...
            <div style={{ display: 'flex'}}>
                <DialogContent style={{ flex: 1 }}>
                    <DialogContentText>
                        Use this form to add a new item to your catalog.
                    </DialogContentText>
                    <TextInput
                        ref={itemNameRef}
            ...
            <DialogActions>
                ...
                <AsyncButton callback={createItem} color="primary" startIcon={<IconAdd/>}>
                    Create
                </AsyncButton>
            </DialogActions>
        </Dialog>
